...
public abstract class FalseScorpion extends Arachnid {
    public FalseScorpion(String name, String describe, int age, Class<? extends AnimalHouse> livingZone, List<ClimateZone> climateZone, Class<? extends Food> foodType) {
