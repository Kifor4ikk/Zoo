...
//            animalList.add(
//                    animalServiceMapper.chooseRepository(animalsIdAndType.get(id)).findById(id)
//            );
//        }
//        return animalList;
//    }
...
//
//        tempMap.put(animalServiceMapper.chooseRepository(tempAnimalIdTypeAndHouseId.getType()).findById(tempAnimalIdTypeAndHouseId.getId()),
//                animalHouseRepository.findById(tempAnimalIdTypeAndHouseId.getHouseId()));
//        return tempMap;
//    }
//
